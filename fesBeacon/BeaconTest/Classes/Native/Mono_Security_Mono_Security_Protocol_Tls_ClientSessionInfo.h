...
struct  ClientSessionInfo_t816  : public Object_t
{
	...
	ByteU5BU5D_t141* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t141* ___masterSecret_5;
};
struct ClientSessionInfo_t816_StaticFields{
