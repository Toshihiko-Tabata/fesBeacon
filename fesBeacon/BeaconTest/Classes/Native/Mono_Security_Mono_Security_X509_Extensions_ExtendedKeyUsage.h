...
struct  ExtendedKeyUsageExtension_t793  : public X509Extension_t681
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t513 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t793_StaticFields{
	...
	Dictionary_2_t117 * ___U3CU3Ef__switchU24map14_4;
};
