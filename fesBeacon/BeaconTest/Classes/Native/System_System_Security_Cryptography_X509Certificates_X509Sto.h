...
struct  X509Store_t575  : public Object_t
{
	...
	X509Certificate2Collection_t566 * ___list_2;
	...
	X509Store_t589 * ___store_4;
};
struct X509Store_t575_StaticFields{
	...
	Dictionary_2_t117 * ___U3CU3Ef__switchU24mapF_5;
};
