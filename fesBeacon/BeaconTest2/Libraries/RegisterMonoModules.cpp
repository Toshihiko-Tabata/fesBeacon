...
extern "C"
{
	...
	const char*			UnityIPhoneRuntimeVersion = "5.1.1f1";
...
#define DLL_EXPORT __declspec(dllexport)
	...
	DECL_USER_FUNC(InitBeaconServer);
	DECL_USER_FUNC(Transmit);
	DECL_USER_FUNC(InitReceiver);
	DECL_USER_FUNC(StopIOSScan);
}
DLL_EXPORT void RegisterMonoModules()
{
	...
	REGISTER_USER_FUNC(InitBeaconServer);
	REGISTER_USER_FUNC(Transmit);
	REGISTER_USER_FUNC(InitReceiver);
	REGISTER_USER_FUNC(StopIOSScan);
}
